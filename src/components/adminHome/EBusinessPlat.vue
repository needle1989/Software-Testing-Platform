...
<div class='typora-export-content'>
        <div id='write' class=''>
            <h2 id='4-分析电商平台系统测试'><span>4 分析电商平台系统测试</span></h2>
            <figure>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span>用户名，密码</span></td>
                            <td><span>用户名为空或密码为空</span><br><span>用户名不存在</span><br><span>用户名与密码匹配</span><br><span>用户名与密码不匹配</span><br>
                            </td>
                        </tr>
                        <tr>
                            <td><span>支付订单</span></td>
                            <td><span>订单，余额</span></td>
                            <td><span>订单不存在</span><br><span>余额不足</span><br><span>重复支付</span><br><span>成功支付</span><br>
                            </td>
                        </tr>
                        <tr>
                            <td><span>加入购物车</span></td>
                            <td><span>商品，购物车，数量</span></td>
                            <td><span>成功加入购物车</span><br><span>商品不存在</span><br><span>购物车满</span><br><span>商品数量不合法</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
