  ...
  <div class="book_search">
    <el-row style="margin-top: 20px;">
      <el-col :span="14" :offset="4">
        <header class="form_header"><h1>查询图书</h1></header>
        <el-form
          ref="bookFormRef"
          :model="bookForm"
          :rules="bookFormRules"
        ...
        >
          <el-form-item label="书名" prop="book_name">
            <el-input v-model="bookForm.book_name" placeholder="书名"></el-input>
          </el-form-item>
          <el-button type="primary" @click="search" class="submit_btn" style="width:40%; margin-left: 230px;">查询</el-button>
        </el-form>
      </el-col>
    </el-row>
    <el-dialog title="书名搜索" :visible.sync="searchdialogvisible" width="50%">
        ...
        methods: {
            ...
            search() {
                this.$refs.bookFormRef.validate(async valid => {
                    ...
                    let result = await this.$http.get('/apip/api/books/search?name=' + this.bookForm.book_name, {
                        hearders: {
                            'Authorization': Token
                        },
                    })
